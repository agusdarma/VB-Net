...
Public Class BarangAddStaff
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        Else
            If BarangStaff.getKodeItem.Length > 0 Then
                Update(itemType)
                Me.Close()
                BarangStaff.refreshGrid()
            Else
    ...
    Private Function insert(itemType As String) As Integer
        ...
        Return rowEffected
    End Function
    Private Sub BarangAddStaff_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        populateDataStatus()
        populateKategori()
        populateGudang()
        populateSupplier()
        If BarangStaff.getKodeItem.Length > 0 Then
            findItemByCode(BarangStaff.kodeItem)

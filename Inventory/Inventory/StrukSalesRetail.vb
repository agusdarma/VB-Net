...
Public Class StrukSalesRetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication2.StrukSalesRetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trxDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStrukSalesRetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StrukSalesRetail = New StrukSalesRetail()
        rpt.Site = Me.Site
        Return rpt
    End Function

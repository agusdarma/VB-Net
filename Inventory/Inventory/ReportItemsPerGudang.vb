...
Public Class ReportItemsPerGudang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportItemsPerGudang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication2.ReportItemsPerGudang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportItemsPerGudang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportItemsPerGudang = New ReportItemsPerGudang()
        rpt.Site = Me.Site
        Return rpt
    End Function

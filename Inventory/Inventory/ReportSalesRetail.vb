...
Public Class ReportSalesRetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication2.ReportSalesRetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportSalesRetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportSalesRetail = New ReportSalesRetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
